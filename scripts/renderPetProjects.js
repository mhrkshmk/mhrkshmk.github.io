        ...
        articleElement.innerHTML = `
            <header class="flex items-center justify-between">
                ...
                <div class="flex gap-2 items-center">
                    <img src="./assets/icons/github2.svg" class="h-7 w-7 rounded-full" alt="GitHub link" />
                    <a class="cursor-pointer" href="#"><img src="./assets/icons/right-arrow.svg" class="h-6 w-6 rounded-full border border-[#DBDBDB] p-1 group-hover/project-card:-rotate-45 transition-all duration-[600ms]" alt="a right arrow" /></a>
                </div>
            </header>
